...
const BASE_PATH_PATTERN = "/front_7th_chapter4-1/vanilla";
...
if (!prod) {
  ...
  // SSR은 ./dist/vanilla, SSG는 ../../dist/vanilla 사용
  const distPath = base === "/" ? path.join(__dirname, "./dist/vanilla") : path.join(__dirname, "../../dist/vanilla");
